...
const Footer = () => {
	return (
		<div className='footer'>
			<div style={{margin:'0 5%'}} id='footer-content'>
				<div id='buy-imac'>
					<div>
					...
					<div>
						<h2>iMac</h2>
						<p>iMac starting at $1099 <br />
						iMac with Retina 4K display starting at $1299</p>
						<a href='#'>Compare iMac models  <i className="fas fa-arrow-circle-right"></i></a>
					</div>
				</div>
				<div id='services'>
					<div>
						<i className="fas fa-cubes fa-5x"></i>
						<h3>Fast, free delivery</h3>
						<p>Choose free delivery or pick up available items at an Apple Store.</p>
						<a href='#'>Learn More  <i className="fas fa-arrow-circle-right"></i></a>
					</div>
					<div>
					...
					<div>
						...
						<a href='#'>Chat Now   <i className="fas fa-arrow-circle-right"></i></a>
					</div>
					<div>
